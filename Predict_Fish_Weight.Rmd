...
In Perch, Pike, and Roach all the models are the best model since we used height and width for all three. Also the helper filed used was Best Subset Regression.
